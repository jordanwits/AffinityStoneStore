      ...
      <CardContent className="space-y-4">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
          <p className="text-sm text-blue-900 mb-2">
            ...
            universal or restricted, where restricted credits affinity points)
          </p>
          <ul className="text-sm text-blue-800 space-y-1 ml-4">
            <li>• Use positive numbers to add points, negative to deduct</li>
            <li>
              • For affinity points, use point_type <code className="bg-blue-100 px-1 rounded">restricted</code> in
