          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                ...
                if (v === '' || /^\d+$/.test(v)) setPointsAmount(v);
              }}
              disabled={isDevMode || loading}
              placeholder="Amount"
              required
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          >
            ...
            <option value="restricted">Affinity points (Affinity collection only)</option>
          </select>
          <p className="text-xs text-gray-600 mt-1">Affinity points apply at checkout to Affinity-tagged products first.</p>
        </div>
        <div>
          <Input
            label="Reason"
