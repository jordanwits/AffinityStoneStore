              ...
              <div>
                ...
                {!isDevMode && (
                  <p className="text-xs text-gray-500 mt-1">
                    Universal {issuedUniversal.toLocaleString()} · Affinity points{' '}
          ...
          <CardContent className="py-6">
            <div className="flex items-start justify-between">
              <div>
                ...
                {!isDevMode && (
                  <p className="text-xs text-gray-500 mt-1">
                    Universal {redeemedUniversal.toLocaleString()} · Affinity points{' '}
              ...
              {!isDevMode && (
                <div className="flex justify-between py-2 border-b text-xs text-gray-600">
                  ...
                  <span className="font-medium text-gray-800">
                    Universal {(issuedUniversal - redeemedUniversal).toLocaleString()} · Affinity points{' '}
