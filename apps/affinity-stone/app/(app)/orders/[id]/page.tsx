...
export default async function OrderDetailPage({
  ...
  // (037), so this is the part actually being ordered, not necessarily the whole line.
        ...
        <Card className="lg:col-span-2">
          ...
          <CardContent className="space-y-6">
            ...
            {order.tracking_number && (
              <div className="pt-6 border-t">
                <p className="text-sm font-medium text-gray-500 mb-2">Reference</p>
                <Link 
                ...
                <p className="text-xs text-gray-500 mt-1">Opens carrier or reference link when applicable</p>
              </div>
            )}
          </CardContent>
        </Card>
