...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === 'email') {
        ...
        if (!isCompleteNanpDigits(phoneDigits)) {
          setError('Enter a complete US phone number (10 digits, or 11 starting with 1).');
          setLoading(false);
          return;
        }
        const result = await signInWithPhonePassword(phoneDigits, password);
        if (!result.success) {
  ...
  const phoneSubmitDisabled =
    mode === 'phone' && (!isCompleteNanpDigits(phoneDigits) || !password);
      ...
      <div className="max-w-md w-full">
        ...
        <Card>
          <CardHeader>
            ...
            <div className="mt-4 flex rounded-lg border border-gray-200 p-1 bg-gray-50">
              <button
                type="button"
                onClick={() => {
                  setMode('email');
          ...
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="w-full">
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    autoComplete={mode === 'email' ? 'current-password' : 'current-password'}
                    placeholder="••••••••"
              ...
              <Button
                ...
                variant="primary"
                className="w-full"
                disabled={loading || phoneSubmitDisabled}
              >
