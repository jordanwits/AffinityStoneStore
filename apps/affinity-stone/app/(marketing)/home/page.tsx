        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 lg:gap-8 max-w-5xl mx-auto">
            ...
            <div className="group flex gap-5 p-6 bg-white rounded-xl border border-gray-200 hover:border-primary/50 hover:shadow-lg transition-all">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Store Pickup</h3>
                <p className="text-gray-600">Redeem your points and collect your items at our location when they are ready.</p>
              </div>
            </div>
          </div>
        </div>
