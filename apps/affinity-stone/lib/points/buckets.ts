/** Collection tag that marks products spendable with Affinity (restricted) points */
...
/** Mirrors checkout RPC: Affinity bucket applied to Affinity-eligible subtotal first, then universal for the rest. */
