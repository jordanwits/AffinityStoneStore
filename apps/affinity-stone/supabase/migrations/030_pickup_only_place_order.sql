-- Orders are store pickup only: reject new delivery orders at the RPC layer.
...
'Pickup-only: creates order, decrements inventory, deducts points. Rejects non-pickup fulfillment.';
